...
const TempRuleEditorScreen = () => {
  const [rules, setRules] = useState([
    { id: 1, sensor: 'TEMP', condition: '>=', value: 30, action: 'led', actionValue: 'on' },
    { id: 2, sensor: 'TEMP', condition: '>=', value: 30, action: 'servo', actionValue: 20 },
  ]);
    ...
    <ScrollView style={{ padding: 16 }}>
      ...
      {rules.map((rule) => (
        <View key={rule.id} style={{ borderWidth: 1, borderRadius: 8, padding: 12, marginBottom: 16 }}>
          ...
          >
            <Picker.Item label="에어컨 제어" value="led" />
            <Picker.Item label="에어컨 온도 변경" value="servo" />
          </Picker>
...
export default TempRuleEditorScreen
